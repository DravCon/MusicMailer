...
def generate_newsletter_content() -> dict:
    """Call Claude via Bedrock converse API to compile the newsletter."""
...
{{
  ...
  "hifi_corner": [
    ...
    log.info("Calling Claude via Bedrock converse API…")
    resp = requests.post(
        BEDROCK_URL,
        headers={
    ...
    log.info("Bedrock HTTP %s", resp.status_code)
